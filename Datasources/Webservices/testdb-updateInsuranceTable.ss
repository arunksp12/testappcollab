function updateInsuranceTable(){
	var queryStr = "UPDATE \"public\".\"insuranceTable\" SET \"Emailid\"=?,\"MobileNumber\"=?,\"Insurance_Type\"=?,\"Policy_Active_Start_Date\"=?,\"Policy_Expiry_Date\"=?,\"Current_Status\"=?,\"PolicyHolderName\"=?,\"PolicyId\"=? WHERE \"PolicyId\"= ?";
	try{
